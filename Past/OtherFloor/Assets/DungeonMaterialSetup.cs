...
{
    class DungeonMaterialSetupChain
    {  
        public static void InitCustomDungeonMaterial()
        {
            ...
            ceilingBorderGrid.topIndices = new TileIndexList { indices = new List<int> { 41 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.leftIndices = new TileIndexList { indices = new List<int> { 44 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.rightIndices = new TileIndexList { indices = new List<int> { 42 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomIndices = new TileIndexList { indices = new List<int> { 43 }, indexWeights = new List<float> { 1f } };

            ceilingBorderGrid.topLeftIndices = new TileIndexList { indices = new List<int> { 48 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.topRightIndices = new TileIndexList { indices = new List<int> { 45 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomLeftIndices = new TileIndexList { indices = new List<int> { 47 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomRightIndices = new TileIndexList { indices = new List<int> { 46 }, indexWeights = new List<float> { 1f } };

            ceilingBorderGrid.topLeftNubIndices = new TileIndexList { indices = new List<int> { 52 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.topRightNubIndices = new TileIndexList { indices = new List<int> { 49 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomLeftNubIndices = new TileIndexList { indices = new List<int> { 51 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomRightNubIndices = new TileIndexList { indices = new List<int> { 50 }, indexWeights = new List<float> { 1f } };

            ceilingBorderGrid.topCapIndices = new TileIndexList { indices = new List<int> { 53 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.leftCapIndices = new TileIndexList { indices = new List<int> { 56 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.bottomCapIndices = new TileIndexList { indices = new List<int> { 55 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.rightCapIndices = new TileIndexList { indices = new List<int> { 54 }, indexWeights = new List<float> { 1f } };
            ...
            ceilingBorderGrid.verticalIndices = new TileIndexList { indices = new List<int> { 62 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.horizontalIndices = new TileIndexList { indices = new List<int> { 63 }, indexWeights = new List<float> { 1f } };


            ceilingBorderGrid.centerIndices = new TileIndexList { indices = new List<int> { 0 }, indexWeights = new List<float> { 1f } };

            ceilingBorderGrid.borderBottomNubLeftIndices = new TileIndexList { indices = new List<int> { 64 }, indexWeights = new List<float> { 1f } };
            ceilingBorderGrid.borderBottomNubRightIndices = new TileIndexList { indices = new List<int> { 65 }, indexWeights = new List<float> { 1f } };
            ...
            pitBorderGridCave.topIndices = new TileIndexList { indices = new List<int> { 23 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.rightIndices = new TileIndexList { indices = new List<int> { 24 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.bottomIndices = new TileIndexList { indices = new List<int> { 25 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.leftIndices = new TileIndexList { indices = new List<int> { 26 }, indexWeights = new List<float> { 1f } };


            pitBorderGridCave.topLeftNubIndices = new TileIndexList { indices = new List<int> { 34 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.topRightNubIndices = new TileIndexList { indices = new List<int> { 33 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.bottomLeftNubIndices = new TileIndexList { indices = new List<int> { 32 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.bottomRightNubIndices = new TileIndexList { indices = new List<int> { 31 }, indexWeights = new List<float> { 1f } };

            pitBorderGridCave.topRightIndices = new TileIndexList { indices = new List<int> { 27 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.topLeftIndices = new TileIndexList { indices = new List<int> { 30 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.bottomLeftIndices = new TileIndexList { indices = new List<int> { 29 }, indexWeights = new List<float> { 1f } };
            pitBorderGridCave.bottomRightIndices = new TileIndexList { indices = new List<int> { 28 }, indexWeights = new List<float> { 1f } };

            pitBorderGridCave.CenterIndicesAreStrata = false;
            pitBorderGridCave.PitBorderOverridesFloorTile = true;
            floorMaterial.roomFloorBorderGrid = pitBorderGridCave;

            var pitLayoutGrid = TilesetToolbox.CreateBlankIndexGrid();
            pitLayoutGrid.topLeftIndices = new TileIndexList { indices = new List<int> { 67 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.topIndices = new TileIndexList { indices = new List<int> { 67 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.topRightIndices = new TileIndexList { indices = new List<int> { 67 }, indexWeights = new List<float> { 1f } };

            pitLayoutGrid.leftIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.rightIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.bottomLeftIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.bottomRightIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };
            pitLayoutGrid.bottomIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };
            //pitLayoutGrid.centerIndices = new TileIndexList { indices = new List<int> { 66 }, indexWeights = new List<float> { 1f } };


            floorMaterial.pitLayoutGrid = pitLayoutGrid;


            floorMaterial.pitBorderFlatGrid = pitBorderGridCave;
            floorMaterial.pitBorderRaisedGrid = pitBorderGridCave;
