    ...
    public class WoodenCrate
    {
        public static void Init()
        {
            ...
            Alexandria.DungeonAPI.StaticReferences.customPlaceables.Add("WoodenCrateMDLR",
              ...
              {  CreateObject("box_ammo_small", "box_small", "A wooden crate, though this one is suspiciously smaller.", new IntVector2(28, 27), new IntVector2(0, -4)), 0.1f },
              }));
            ...
            /*
            int x = 7;
            int[] Xs = new int[] {1,3,5,2};

            //
            while (x > 0 && Xs.Count() > 0)
            {
