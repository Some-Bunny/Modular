...
namespace ModularMod
{
    public class GravityPulsar : GunBehaviour
    {
        public static void Init()
        {
            ...
            Game.Items.Rename("outdated_gun_mods:singilarity_pulsar", "mdl:armcannon_10");
            ...
            gun.DefaultModule.angleVariance = 25f;
            ...
            Projectile largeProjectile = UnityEngine.Object.Instantiate<Projectile>((PickupObjectDatabase.GetById(56) as Gun).DefaultModule.projectiles[0]);
            largeProjectile.gameObject.SetActive(false);
            FakePrefab.MarkAsFakePrefab(largeProjectile.gameObject);
            UnityEngine.Object.DontDestroyOnLoad(largeProjectile);
