...
namespace ModularMod
{
    public class DefaultArmCannonAlt : GunBehaviour
    {
        ...
        {
            Gun gun = ETGMod.Databases.Items.NewGun("Modular Arm Cannon Alt", "defaultarmcannonalt");
            Game.Items.Rename("outdated_gun_mods:modular_arm_cannon_alt", "mdl:armcannon_0_alt");
            ...
            GunExt.SetupSprite(gun, null, "defaultarmcannonalt_idle_001", 11);
            ...
            projectile.SetProjectileSpriteRight("defaultarmcannonalt_projectile_001", 4, 4, false, tk2dBaseSprite.Anchor.LowerCenter);
