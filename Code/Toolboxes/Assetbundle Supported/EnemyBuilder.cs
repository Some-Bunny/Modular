...
namespace ModularMod
{
    public static class EnemyBuilder
    {
        ...
        */
        ...
        public static GameObject BuildPrefabBundle(string name, string guid, tk2dSpriteCollectionData customCollection, string spriteName, IntVector2 hitboxOffset, IntVector2 hitBoxSize, bool HasAiShooter, bool UsesAttackGroup = false)
        {
            if (HasAiShooter)
            {
                var actor = EnemyDatabase.GetOrLoadByGuid("3cadf10c489b461f9fb8814abc1a09c1");
