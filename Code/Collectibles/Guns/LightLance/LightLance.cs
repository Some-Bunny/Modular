...
namespace ModularMod
{
    public class LightLance : GunBehaviour
    {
        public static void Init()
        {
            ...
            GunInt.SetupSprite(gun, StaticCollections.Gun_Collection, "coollance_idle_001");
            ...
            projectileSlashingBehaviour.slashParameters.hitVFX = (PickupObjectDatabase.GetById(545) as Gun).DefaultModule.projectiles[0].hitEffects.enemy;
            ...
            projectile.AnimateProjectileBundle("swordslash", StaticCollections.Projectile_Collection, StaticCollections.Projectile_Animation, "swordslash",
            ...
            yes.dashColor = new Color(0f, 0.7f, 0.7f, 0.666f);
        ...
        public class SpeedUp : MonoBehaviour
        {
            ...
            public void Start()
            {
                ...
                if (self)
                {
                    self.IgnoreTileCollisionsFor(15);
                }
            }

            public void Update()
            {
                if (self && elapsed > 0 && elapsed < 1.5f)
                {
                    self.UpdateSpeed();
