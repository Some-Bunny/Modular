...
namespace ModularMod
{
    public class FortifierAlt : GunBehaviour
    {
        ...
        {
            Gun gun = ETGMod.Databases.Items.NewGun("Fortifier", "turretplaceralt");
            Game.Items.Rename("outdated_gun_mods:fortifier", "mdl:armcannon_15_alt");
            var c = gun.gameObject.AddComponent<FortifierAlt>();
            ...
            GunInt.SetupSprite(gun, StaticCollections.Gun_Collection, "turretplaceralt_idle_001");
            gun.spriteAnimator.Library = StaticCollections.Gun_Animation;
            gun.sprite.SortingOrder = 1;
            gun.idleAnimation = "turretplaceralt_idle";
            gun.shootAnimation = "turretplaceralt_fire";
            gun.reloadAnimation = "turretplaceralt_reload";
            gun.introAnimation = "turretplaceralt_intro";
            ...
            projectile.AnimateProjectileBundle("turretidlealt", StaticCollections.Projectile_Collection, StaticCollections.Projectile_Animation, "turretidlealt",
            ...
            yes1.dashColor = new Color(0, 0.5f, 0, 1f);
            ...
            turretProjectile.AnimateProjectileBundle("longshotalt_idle", StaticCollections.Projectile_Collection, StaticCollections.Projectile_Animation, "longshot_idle",
            ...
            TurretComponent.projectileToFireAlt = turretProjectile;
            ...
            gun.DefaultModule.customAmmoType = CustomClipAmmoTypeToolbox.AddCustomAmmoType("TurretBallAlt", StaticCollections.Clip_Ammo_Atlas, "turretalt_1", "turretalt_2");
            ...
            FortifierAlt.GunID = gun.PickupObjectId;
