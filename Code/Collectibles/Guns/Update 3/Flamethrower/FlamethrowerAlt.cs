...
namespace ModularMod
{
    public class FlamethrowerAlt : GunBehaviour
    {
        ...
        {
            Gun gun = ETGMod.Databases.Items.NewGun("Flame Ejector", "flamethroweralt");
            Game.Items.Rename("outdated_gun_mods:flame_ejector", "mdl:armcannon_13_alt");
            var c = gun.gameObject.AddComponent<FlamethrowerAlt>();
            ...
            GunInt.SetupSprite(gun, StaticCollections.Gun_Collection, "flameralt_idle_001");
            gun.spriteAnimator.Library = StaticCollections.Gun_Animation;
            gun.sprite.SortingOrder = 1;
            gun.idleAnimation = "flameralt_idle";
            gun.shootAnimation = "flameralt_fire";
            gun.reloadAnimation = "flameralt_reload";
            gun.introAnimation = "flameralt_intro";
            gun.emptyAnimation = "flameralt_empty";
        ...
        public void Process(ModulePrinterCore modulePrinterCore, Projectile p, int stack, PlayerController player)
        {
            ...
            p.baseData.damage += 0.1f * stack;
            p.baseData.speed *= 1 + (0.25f * stack);
            p.FireApplyChance = 0.1f * stack;
            p.baseData.force += stack;
            p.fireEffect = DebuffStatics.greenFireEffect;
            p.AdjustPlayerProjectileTint(new Color(0, 3, 0, 1), 10);
        }
