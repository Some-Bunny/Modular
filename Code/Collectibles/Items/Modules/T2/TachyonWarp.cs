...
namespace ModularMod
{
    public class TachyonWarp : DefaultModule
    {
        public static ItemTemplate template = new ItemTemplate(typeof(TachyonWarp))
        {
            ...
            LongDescription = "Greatly increases accuracy, adds slight homing to your projectiles and slightly increases damage (+Stronger Homing and Damage per stack). Projectiles fire from walls, instead of your gun. Firing slightly pushes away nearby enemies. (+Stronger push force per stack).",
        ...
        public static void PostInit(PickupObject v)
        {
            ...
            h.SetName("Tachyon Warp " + h.ReturnTierLabel());
