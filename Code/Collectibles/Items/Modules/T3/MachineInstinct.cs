...
namespace ModularMod
{
    public class MachineInstinct : DefaultModule
    {
        public static ItemTemplate template = new ItemTemplate(typeof(MachineInstinct))
        {
            ...
            LongDescription = "Being in proximity of projectiles and enemies increases Risk, which increases Rate Of Fire and Damage. (+Higher Risk Capacity per stack). Building up enough Risk allows you to negate one instance of damage, providing you with 2.5 second of invulnerability. Ability recharges after 15 (-20% hyperbolically per stack) seconds.",
