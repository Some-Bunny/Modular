...
namespace ModularMod
{
    public class GravityWell : DefaultModule
    {
        public static ItemTemplate template = new ItemTemplate(typeof(GravityWell))
        {
            ...
            LongDescription = "Greatly reduces Fire Rate. Projectiles gain piercing and greatly reduced speed. Enemies are magnetically pulled towards your projectiles, and are hurt in their proximity.(+Stronger Gravity And Damage per stack).",
