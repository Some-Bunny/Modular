...
namespace ModularMod
{
    public class MonetaryValue : DefaultModule
    {
        public static ItemTemplate template = new ItemTemplate(typeof(MonetaryValue))
        {
            ...
            LongDescription = "Gain 0.5% (+0.5% per stack) damage for each casing you have. Your casing value is increased by 25% every floor." + "\n\n" + "Tier:\n" + DefaultModule.ReturnTierLabel(DefaultModule.ModuleTier.Tier_1),
        ...
        {
            player.carriedConsumables.Currency += (player.carriedConsumables.Currency / 4);
