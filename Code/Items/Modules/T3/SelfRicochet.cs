...
namespace ModularMod
{
    public class SelfRicochet : DefaultModule
    {
        ...
        public static void PostInit(PickupObject v)
        {
            ...
            h.LabelDescription = "Player Projectiles bounce off walls, enemies and each other, with force (" + StaticColorHexes.AddColorToLabelString("+Extra Force", StaticColorHexes.Light_Orange_Hex) + "). Increases rate of fire (" + StaticColorHexes.AddColorToLabelString("+25% hyperbolically", StaticColorHexes.Light_Orange_Hex) + ")\n and increases spread.";
