...
namespace ModularMod
{
    public class LaserLance : DefaultModule
    {
        public static ItemTemplate template = new ItemTemplate(typeof(LaserLance))
        {
            Name = "Laser Lance",
            Description = "Pointy",
            LongDescription = "Reduces projectile speed by 50%. Projectiles will now have Laser Lances that point in the direction the projectile is moving. (+Lance Damage And Range per stack)" + "\n\n" + "Tier:\n" + DefaultModule.ReturnTierLabel(DefaultModule.ModuleTier.Tier_2),
        ...
        public static void PostInit(PickupObject v)
        {
            ...
            h.LabelDescription = "Reduces projectile speed by 50%. Projectiles will now have\nLaser Lances that point in the direction the projectile is moving.\n(" + StaticColorHexes.AddColorToLabelString("+Lance Damage And Range", StaticColorHexes.Light_Orange_Hex) + ")";
