...
namespace ModularMod
{
    ...
    public class Module : BaseUnityPlugin
    {
        ...
        public void GMStart(GameManager g)
        {
            ...
            ConsoleMagic.LogButCool($"{NAME} v{VERSION} started successfully.", Module.ModularAssetBundle.LoadAsset<Texture2D>(UnityEngine.Random.value < 0.05f ? "modular_Tex_Icon_Pog" : "modular_Tex_Icon"));
